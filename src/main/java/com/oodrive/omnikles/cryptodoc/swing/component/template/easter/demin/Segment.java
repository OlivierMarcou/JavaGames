...
//Afficheur 3 chiffres e 7 segments chacun;
//utilise pour le temps et les mines
public class Segment extends JPanel {
  ...
  */
  ...
  private int valeur;
  final private Color AFFICHE = new Color(255,0,0);//couleur d'un segment allume
  final private Color CACHE = new Color(80,0,0);//couleur d'un segment eteint
  ...
  public void paintComponent(Graphics g) {
    ...
    int[] segments=new int[3];//le chiffre affiche par chaque afficheur
